...
namespace API.Nodes
{
    public class GraphNode : Godot.GraphNode, IRubyControl
    {
        public object Emitter;
        object _rubyOwner;

        public GraphNode(object rubyOwner)
        {
        ...
        public override void _Ready()
        {
            ...
            Connect("offset_changed", this, nameof(OnOffsetChanged));
            Connect("raise_request", this, nameof(OnRaiseRequest));
            Connect("resize_request", this, nameof(OnResizeRequest));
            Connect("slot_updated", this, nameof(OnSlotUpdated));
        ...
        #region GraphNode
        void OnCloseRequest() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "close_request");
        void OnDragged(Vector2 from, Vector2 to) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "dragged", from, to);
        void OnOffsetChanged() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "offset_changed");
        void OnRaiseRequest() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "raise_request");
        void OnResizeRequest(Vector2 newMinSize) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "resize_request", newMinSize);
        void OnSlotUpdated(int idx) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "slot_updated", idx);
        #endregion
    }
}