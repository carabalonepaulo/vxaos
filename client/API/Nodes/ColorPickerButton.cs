...
namespace API.Nodes
{
    public class ColorPickerButton : Godot.ColorPickerButton, IRubyControl
    {
        public object Emitter;
        object _rubyOwner;

        public ColorPickerButton(object rubyOwner)
        {
        ...
        public override void _Ready()
        {
            ...
            Connect("picker_created", this, nameof(OnPickerCreated));
            Connect("popup_closed", this, nameof(OnPopupClosed));
        ...
        void OnColorChanged(Color color) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "color_changed");
        void OnPickerCreated() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "picker_created");
        void OnPopupClosed() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "popup_closed");
        #endregion
    }
}