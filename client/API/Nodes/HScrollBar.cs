...
namespace API.Nodes
{
    public class HScrollBar : Godot.HScrollBar, IRubyControl
    {
        public object Emitter { get; set; }

        object _rubyOwner;

        public HScrollBar(object rubyOwner)
        {
        ...
        public override void _Ready()
        {
            ...
            // ScrollBar
            Connect("scrolling", this, nameof(OnScrolling));
        ...
        #region ScrollBar
        void OnScrolling() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "scrolling");
        #endregion
    }
}