...
namespace API.Nodes
{
    public class HSplitContainer : Godot.HSplitContainer, IRubyControl
    {
        public object Emitter;
        object _rubyOwner;

        public HSplitContainer(object rubyOwner)
        {
        ...
        void OnDragged(int offset) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "dragged", offset);
        #endregion
    }
}