...
namespace API.Nodes
{
    public class GraphEdit : Godot.GraphEdit, IRubyControl
    {
        public object Emitter { get; set; }

        object _rubyOwner;

        public GraphEdit(object rubyOwner)
        {
        ...
        public override void _Ready()
        {
            ...
            // GraphEdit
            Connect("_begin_node_mode", this, nameof(OnBeginNodeMove));
            Connect("_end_node_move", this, nameof(OnEndNodeMove));
            Connect("connection_from_empty", this, nameof(OnConnectionFromEmpty));
            Connect("connection_request", this, nameof(OnConnectionRequest));
            Connect("connection_to_empty", this, nameof(OnConnectionToEmpty));
            Connect("copy_nodes_request", this, nameof(OnCopyNodesRequest));
            Connect("delete_nodes_request", this, nameof(OnDeleteNodesRequest));
            Connect("disconnection_request", this, nameof(OnDisconnectionRequest));
            Connect("duplicate_nodes_request", this, nameof(OnDuplicateNodesRequest));
            Connect("node_selected", this, nameof(OnNodeSelected));
            Connect("node_unselected", this, nameof(OnNodeUnselected));
            Connect("paste_nodes_request", this, nameof(OnPasteNodesRequest));
            Connect("popup_request", this, nameof(OnPopupRequest));
            Connect("scroll_offset_changed", this, nameof(OnScrollOffsetChanged));
        ...
        #region GraphEdit
        void OnBeginNodeMove() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "_begin_node_move");
        void OnEndNodeMove() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "_end_node_move");
        void OnConnectionFromEmpty(string to, int toSlot, Vector2 releasePosition) =>
            RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "connection_from_empty");
        void OnConnectionRequest(string from, int fromSlot, string to, int toSlot) =>
            RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "connection_request");
        void OnConnectionToEmpty(string from, int fromSlot, Vector2 releasePosition) =>
            RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "connection_to_empty");
        void OnCopyNodesRequest() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "copy_nodes_request");
        void OnDeleteNodesRequest() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "delete_nodes_request");
        void OnDisconnectionRequest(string from, int fromSlot, string to, int toSlot) =>
            RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "disconnection_request", from, fromSlot, to, toSlot);
        void OnDuplicateNodesRequest() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "duplicate_nodes_request");
        void OnNodeSelected(Node node) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "node_selected", node);
        void OnNodeUnselected(Node node) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "node_unselected", node);
        void OnPasteNodesRequest() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "paste_nodes_request");
        void OnPopupRequest(Vector2 position) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "popup_request", position);
        void OnScrollOffsetChanged(Vector2 offset) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "scroll_offset_changed", offset);
        #endregion
    }
}