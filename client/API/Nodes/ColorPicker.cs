...
namespace API.Nodes
{
    public class ColorPicker : Godot.ColorPicker, IRubyControl
    {
        public object Emitter;
        object _rubyOwner;

        public ColorPicker(object rubyOwner)
        {
        ...
        public override void _Ready()
        {
            ...
            Connect("preset_added", this, nameof(OnPresetAdded));
            Connect("preset_removed", this, nameof(OnPresetRemoved));
        ...
        #region ColorPicker
        void OnColorChanged(Color color) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "color_changed", color);
        void OnPresetAdded(Color color) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "preset_added", color);
        void OnPresetRemoved(Color color) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "preset_removed", color);
        #endregion
    }
}