...
namespace API.Nodes
{
    public class Tabs : Godot.Tabs, IRubyControl
    {
        ...
        #region Tabs
        void OnRepositionActiveTabRequest(int idxTo) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "reposition_active_tab_request", idxTo);
        void OnRightButtonPressed(int tab) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "right_button_pressed", tab);
