...
namespace API.Nodes
{
    public class OptionButton : Godot.OptionButton, IRubyControl
    {
        public object Emitter;
        object _rubyOwner;

        public OptionButton(object rubyOwner)
        {
        ...
        public override void _Ready()
        {
            ...
            // OptionButton
            Connect("item_focused", this, nameof(OnItemFocused));
        ...
        #region OptionButton
        void OnItemFocused(int index) => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "item_focused", index);
