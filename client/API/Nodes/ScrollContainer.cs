...
namespace API.Nodes
{
    public class ScrollContainer : Godot.ScrollContainer, IRubyControl
    {
        public object Emitter;
        object _rubyOwner;

        public ScrollContainer(object rubyOwner)
        {
        ...
        public override void _Ready()
        {
            ...
            // ScrollContainer
            Connect("scroll_ended", this, nameof(OnScrollEnded));
            Connect("scroll_started", this, nameof(OnScrollStarted));
        ...
        void OnScrollEnded() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "scroll_ended");
        void OnScrollStarted() => RubyEnvironment.Engine.Operations.InvokeMember(Emitter, "emit", "scroll_started");
        #endregion
    }
}